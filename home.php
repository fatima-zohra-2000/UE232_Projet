...
<body>
    ...
    <nav class="sidenav">
        <a href="#" class="sidenav-brand">Gestionnaire des courriers</a>
        ...
        <a href="gestiondirection.php" class="sidenav-item"><i class="fa-solid fa-compass sidenav-icon"></i>Gestion des directions</a> 
        <a href="about.php" class="sidenav-item"><i class="fa fa-light fa-circle-info sidenav-icon"></i>A propos de l'app</a>
        ...
        <article class="main-article">
            ...
            <div class="blocs parent">
                <?php 
                    ...
                    // $simple_users=$cnx->query('SELECT * FROM `utilisateurs` WHERE `user_type`= `simple`');
                    // $admin_users=$cnx->query('SELECT * FROM `utilisateurs` WHERE `user_type`= `admin`');
                    // $email = $cnx->query("SELECT * FROM `courriers` WHERE `code_etab` = '".$_SESSION['username']."'");
                    ...
                    // $email_send=$cnx->query('SELECT * FROM `entrant`');
                    // $email_received=$cnx->query('SELECT * FROM `sortant`');
