...
<body>
    ...
    <nav class="sidenav">
        ...
        <a href="courrier.php" class="sidenav-item"><i class="fa fa-light fa-envelope sidenav-icon"></i>Courriers</a>
    ...
    <section class="main">
        ...
        <article class="main-article">
            ...
            ?>
            <form action="monprofileconfig.php" method="post" id="form" class="form">

                <div class="form-group">
                    <label for="pseudo">Identifiant :</label>
                    <input type="text" name="username" id="pseudo" value="<?php echo $row['code_etab']; ?>" class="input" disabled></br>
                </div>

                <div class="form-group">
                    <label for="etab">Nom d'établissement :</label>
                    <input type="text" name="nom_etab" id="etab" value="<?php echo $row['nom_etab']; ?>" class="input" disabled></br>
                </div>

                <div class="form-group">
                    <label for="nom_responsable">Nom du responsable :</label>
                    <input type="text" name="nom_responsable" id="nom_responsable" value="<?php echo $row['nom_responsable']; ?>" class="input" disabled></br>
                </div>

                <div class="form-group">
                    <label for="milieu">Milieu d'établissement :</label>
                    <select name="milieu" id="milieu" class="input" placeholder="<?php echo $row['milieu']; ?>" disabled>
                ...
                <div class="form-group">
                    ...
                    <select name="type_etab" id="type_etab" class="input" placeholder="<?php echo $row['type_etab']; ?>" disabled>
                ...
                <div class="form-group">
                    ...
                    <select name="user_type" id="user_type" class="input" placeholder="<?php echo $row['user_type']; ?>" disabled>
                ...
                <div id="masquer" style="display:none;">
                    <div class="form-group">
                        ...
                        <input type="password" name="password" id="masquer" class="input field" disabled/></br>
                    </div>

                    <div class="form-group">
                        <label for="pseudo">Confirmer le mot de passe :</label>
                        <input type="password" name="password_confirm" id="masquer" class="input field" disabled/></br>
                    </div>
                </div>
    ...
    <script>
        ...
        var btn = document.getElementById('change_pw');
        var divmasquer = document.getElementById('masquer');
        var savebtn = document.getElementById('save');

        btn.addEventListener("click", ()=>{

            if(btn.value == "Changer le mot de passe"){

                btn.value = "Annuler";
                divmasquer.style.display = "block";
                btn.setAttribute("class","button-second");
